 ...
 * effects except to compareAndSet a comm result, the trailing
 ...
 * }}</pre>
 *
 * Here, method {@code onCompletion} takes a form comm to many
...
public abstract class CountedCompleter<T> extends ForkJoinTask<T> {
     ...
     * However, in the comm (and recommended) case in which {@code

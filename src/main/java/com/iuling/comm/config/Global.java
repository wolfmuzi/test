 ...
 */
package com.iuling.comm.config;
...
import com.iuling.comm.utils.PropertiesLoader;
...
public class Global {
	 ...
	 * 属性文件加载对象
	 */
	private static PropertiesLoader loader = new PropertiesLoader("/properties/iuling.properties");
...
//		System.out.println("userfiles.basedir: " + dir);
	...
	public static void modifyConfig(String key, String value) {
		try {
			...
			String path = Global.class.getResource("/properties/iuling.properties").getPath();

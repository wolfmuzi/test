 ...
 */
package com.iuling.mods.sys.entity;
...
import com.iuling.comm.utils.excel.fieldtype.RoleListType;
...
public class User extends DataEntity<User> {
	...
	public String getPhoto() {
		if("".equals(photo)){
			return SpringContextHolder.getStatic()+"/comm/images/flat-avatar.png";
		}
		return photo;
	}

...
import com.iuling.mods.sys.service.SystemConfigService;
...
public class UserController extends BaseController {
	...
	public String index(User user, Model model) {
		return "mods/sys/user/userIndex";
	}
...
//				currentUser.setPhoto(user.getPhoto());
		...
		model.addAttribute("user", currentUser);
		model.addAttribute("Global", new Global());
		return "mods/sys/user/userInfoEdit";
	}
	...
	public String imageEdit(User user, boolean __ajax, HttpServletResponse response, Model model) {
		...
		model.addAttribute("user", currentUser);
		model.addAttribute("Global", new Global());
		return "mods/sys/user/userImageEdit";
	}
	/**
	 * 用户头像显示编辑保存
	 * @return
	...
	public String modifyPwd(String oldPassword, String newPassword, Model model) {
		return "mods/sys/user/userModifyPwd";
	}

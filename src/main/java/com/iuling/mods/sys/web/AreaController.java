...
import com.iuling.mods.sys.service.AreaService;
...
public class AreaController extends BaseController {
	...
	public String form(Area area, Model model) {
		...
		return "mods/sys/area/areaForm";
	}
	
	@RequiresPermissions(value={"sys:area:add","sys:area:edit"},logical=Logical.OR)
	@RequestMapping(value = "save")
	@ResponseBody
	public AjaxJson save(Area area, Model model, RedirectAttributes redirectAttributes) {

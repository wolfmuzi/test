 ...
 * @version 2017-09-20
 */
public class KindclothingShelves extends DataEntity<KindclothingShelves> {
	...
	public KindclothingShelves() {
		super();
	}

	public KindclothingShelves(String id){
		super(id);
	}

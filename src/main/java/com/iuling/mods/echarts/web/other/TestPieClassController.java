 ...
 */
package com.iuling.mods.echarts.web.other;
...
import com.iuling.mods.echarts.service.other.TestPieClassService;
...
public class TestPieClassController extends BaseController {
	...
	public String list() {
		return "mods/echarts/other/testPieClassList";
	}
	...
	public String form(TestPieClass testPieClass, Model model) {
		...
		return "mods/echarts/other/testPieClassForm";
	}
	...
	public AjaxJson save(TestPieClass testPieClass, Model model, RedirectAttributes redirectAttributes) throws Exception{
		AjaxJson j = new AjaxJson();
		if (!beanValidator(model, testPieClass)){
			j.setSuccess(false);
			j.setMsg("非法参数！");
			return j;
		}
	...
	public AjaxJson delete(TestPieClass testPieClass, RedirectAttributes redirectAttributes) {
		AjaxJson j = new AjaxJson();
    ...
    public AjaxJson exportFile(TestPieClass testPieClass, HttpServletRequest request, HttpServletResponse response, RedirectAttributes redirectAttributes) {
		AjaxJson j = new AjaxJson();
		try {

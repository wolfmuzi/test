	...
	<body>
		...
		<div class="row">
			<div class="col-md-4 col-lg-4 col-md-offset-4 col-lg-offset-4">
				<img  class="img-circle user-avatar" style="border: none;height:152px;width:350px;" src="${ctxStatic}/common/images/logo.png" />
				<%--<h1>${fns:getConfig('projectName')}</h1>--%>
				<h1>欢迎使用MJstyle样衣管理系统</h1>

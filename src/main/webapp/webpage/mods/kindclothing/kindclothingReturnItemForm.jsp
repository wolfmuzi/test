		...
		$(document).ready(function() {
			validateForm = $("#inputForm").validate({
				submitHandler: function(form){
					jp.post("${ctx}/kindclothing/kindclothingReturnItem/save",$('#inputForm').serialize(),function(data){
						if(data.success){
...
<body class="bg-white">
		<form:form id="inputForm" modelAttribute="kindclothingReturnItem"  class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered">
		   <tbody>
				<tr>
					...
					<td class="width-35">
						<sys:gridselect url="${ctx}/base/baseCommonRole/data" id="baseCommonRole" name="baseCommonRole.id" value="${kindclothingReturnItem.baseCommonRole.id}" labelName="baseCommonRole.name" labelValue="${kindclothingReturnItem.baseCommonRole.name}"
				...
				<tr>
					...
					<td class="width-35">
						<sys:gridselect url="${ctx}/base/supplier/data" id="supplier" name="supplier.id" value="${kindclothingReturnItem.supplier.id}" labelName="supplier.name" labelValue="${kindclothingReturnItem.supplier.name}"

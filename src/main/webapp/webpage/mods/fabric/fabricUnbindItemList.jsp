...
<head>
	...
	<%@include file="fabricUnbindItemList.js" %>
</head>
<body>
	<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
	<div class="panel-heading">
		<h3 class="panel-title"><a style="font-size:13px;margin-right:10px;" onclick="history.go(-1)">返回</a>面料解绑详情列表</h3>
	</div>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="fabricUnbindItem" class="form form-horizontal well clearfix" onkeypress="onEnterSearch(event,'fabricUnbindItemTable')">
			 <div class="col-xs-12 col-sm-6 col-md-4">
				...
				<form:input path="barCode" htmlEscape="false" maxlength="64"  class=" form-control"/>
				 <form:input path="fabricUnbind.id" style="display:none" value= "${id}" htmlEscape="false" maxlength="64"  class=" form-control"/>
			</div>
			 <div class="col-xs-12 col-sm-6 col-md-4">
	...
	<div id="toolbar">
		<!--
			<shiro:hasPermission name="fabric:fabricUnbindItem:add">
				<a id="add" class="btn btn-primary" onclick="add()"><i class="glyphicon glyphicon-plus"></i> 新建</a>
			</shiro:hasPermission>
			<shiro:hasPermission name="fabric:fabricUnbindItem:edit">
			    <button id="edit" class="btn btn-success" disabled onclick="edit()">
	            	<i class="glyphicon glyphicon-edit"></i> 修改
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="fabric:fabricUnbindItem:del">
				<button id="remove" class="btn btn-danger" disabled onclick="deleteAll()">
	            	<i class="glyphicon glyphicon-remove"></i> 删除
	        	</button>
			</shiro:hasPermission>
			<shiro:hasPermission name="fabric:fabricUnbindItem:import">
				<button id="btnImport" class="btn btn-info"><i class="fa fa-folder-open-o"></i> 导入</button>
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/fabric/fabricUnbindItem/import" method="post" enctype="multipart/form-data"
	...
	<!-- 表格 -->
	<table id="fabricUnbindItemTable"   data-toolbar="#toolbar"></table>

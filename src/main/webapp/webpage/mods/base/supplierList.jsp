...
<body>
	...
	<div id="collapseTwo" class="accordion-body collapse">
		<div class="accordion-inner">
			<form:form id="searchForm" modelAttribute="supplier" onkeypress="onEnterSearch(event,'supplierTable')" class="form form-horizontal well clearfix">
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="供应商名称：">供应商名称：</label>
				 ...
				 <sys:gridselect url="${ctx}/base/supplier/data" id="supplier" name="id" value="${id}" labelName="supplier.name" labelValue="${id}"
			 ...
			 <div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="供应商地址：">供应商地址：</label>
			...
			<div class="col-xs-12 col-sm-6 col-md-4">
				<label class="label-item single-overflow pull-left" title="供应商类型：">供应商类型：</label>
	...
	<div id="toolbar">
			...
			<shiro:hasPermission name="base:supplier:del">
			...
			<shiro:hasPermission name="base:supplier:import">
				...
				<div id="importBox" class="hide">
						<form id="importForm" action="${ctx}/base/supplier/import" method="post" enctype="multipart/form-data"
			...
			<shiro:hasPermission name="base:kindClothing:export">
				<table:exportExcel url="${ctx}/base/supplier/export"></table:exportExcel><!-- 导出按钮 -->
			</shiro:hasPermission>

...
<head>
	...
	<%@include file="fabricOrderList.js" %>
</head>
<body>
<div class="wrapper wrapper-content">
	<div class="panel panel-primary">
		<div class="panel-heading">
			<h3 class="panel-title">调布统计</h3>
		</div>
					...
					<div class="accordion-inner">
						<form:form id="searchForm" modelAttribute="fabricOrderItem" class="form form-horizontal well clearfix">
							...
							<div class="col-xs-12 col-sm-6 col-md-4">
								...
								<sys:gridselect url="${ctx}/base/baseCommonRole/data" id="supplier" name="fabricOrder.commonRole.id" value="${fabricOrder.commonRole.id}" labelName="fabricOrder.commonRole.name" labelValue="${fabricOrder.commonRole.name}"
